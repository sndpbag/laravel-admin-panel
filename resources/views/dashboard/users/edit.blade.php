...
@section('title', 'Edit User - sndp-bag Dashboard')
...
<div class="flex items-center gap-2 mb-6 text-sm">
    ...
    <span class="text-gray-900 dark:text-gray-100 font-semibold">Edit User</span>
</div>
...
<div class="relative bg-white dark:bg-gray-900 rounded-3xl shadow-xl overflow-hidden fade-in">
    ...
    <div class="p-8 border-b border-gray-100 dark:border-gray-800">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h3 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Edit User</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update information for {{ $user->name }}</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 border-2 border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-600 transition-all duration-300">
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-4 text-center">Profile Image</label>
                    ...
                    <div class="relative mx-auto w-48 h-48 mb-6">
                        <img id="imagePreview" 
                             ...
                             src="{{ $user->profile_image ? asset('storage/' . $user->profile_image) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=random&size=192&bold=true' }}" 
                             alt="Profile Preview">
                        <div class="absolute -bottom-3 -right-3 w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl border-4 border-white dark:border-gray-900">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 text-center mt-3">Recommended: Square image, at least 400x400px</p>
                </div>
            </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <!-- Password Section -->
                <div class="bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 rounded-2xl p-6 border-2 border-amber-200 dark:border-amber-800">
                    ...
                    <p class="text-sm text-amber-700 dark:text-amber-300 mb-5">Leave blank to keep the current password</p>
        ...
        <!-- Action Buttons -->
        <div class="p-8 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-end gap-3">
